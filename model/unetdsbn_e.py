...
class Unet2D(nn.Module):
    ...
    def forward(self, x, weights=None, domain_label=None):
        if weights == None:
            ...
            y1_2 = self.convu1_2(y2_1, x1, domain_label=domain_label)

            y3_1 = self.convu3_1(x4, x3, domain_label=domain_label)
            y2_2 = self.convu2_2(y3_1, x2, domain_label=domain_label)
            y1_3 = self.convu1_3(y2_2, x1, domain_label=domain_label)
            ...
            y1_2 = self.convu1_2(y2_1, x1, weights=weights, layer_idx='module.convu1_2', domain_label=domain_label)

            y3_1 = self.convu3_1(x4, x3, weights=weights, layer_idx='module.convu3_1', domain_label=domain_label)
            y2_2 = self.convu2_2(y3_1, x2, weights=weights, layer_idx='module.convu2_2', domain_label=domain_label)
            y1_3 = self.convu1_3(y2_2, x1, weights=weights, layer_idx='module.convu1_3', domain_label=domain_label)
